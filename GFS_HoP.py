...
mkdir_p(output_dir)
mkdir_p(output_dir+'/GFS_HoP') #create subdirectory to store GFS output like this
...
for i in range(0,120):
    ...
    ######## Save the plot
    plt.savefig(output_dir+'/GFS_HoP/gfs_hrly_pytpe_gyx_sound_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    fcst_hr = str(0)
    plt.close()
    plt.clf()