...
for i in range(0,45):
    ...
    plt.figtext( 0.15, 0.30, 'Levels (m):', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.28, 'LCL:', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.28, f'{lcl}', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.26, 'LFC:', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.26, f'{lfc}', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.24, 'EL:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.24, f'{el}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.22, 'MPL:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.22, f'{mpl}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.20, 'CCL:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.20, f'{ccl}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.18, '0C:', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.18, f'{hgt0c}', fontsize=12,  backgroundcolor='white', color='black')
    plt.figtext( 0.15, 0.16, 'PBL:', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.17, 0.16, f'{pbl}', fontsize=12, backgroundcolor='white', color='black')
    plt.figtext( 0.37, 0.10, 'SBCAPE:', fontsize=14,  backgroundcolor='white', color='black')
