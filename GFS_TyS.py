...
mkdir_p(output_dir)
mkdir_p(output_dir+'/GFS_TyS') #create subdirectory to store GFS output like this
...
for i in range(0,120):
	...
	#Plot 2m 20F isotherm
    tmp_2m20 = ax1.contour(x,y,t2m,colors='darkviolet', alpha = 0.8, levels = [20])
    ...
    ######## Save the plot
    plt.savefig(output_dir+'/GFS_TyS/gfs_hrly_pytpe_gyx_sound_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    fcst_hr = str(0)
    plt.close()
    plt.clf()